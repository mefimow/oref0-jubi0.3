...
mkdir -p ~/src
curl -s https://raw.githubusercontent.com/Diadon81/oref0-jubi0.3/master/openaps-packages.sh | bash -
cd ~/src && git clone git://github.com/openaps/oref0.git || (cd oref0 && git checkout v0.6.3 && git pull)
